...
const val SHR: Opcode = 0x32u
const val SHL: Opcode = 0x33u
...
const val CMP_TRUE: Opcode = 0x34u
const val CMP_FALSE: Opcode = 0x35u
const val PUSHEQ: Opcode = 0x36u
const val PUSHNE: Opcode = 0x37u
const val PUSHLT: Opcode = 0x38u
const val PUSHGT: Opcode = 0x39u
const val PUSHLE: Opcode = 0x3Au
const val PUSHGE: Opcode = 0x3Bu
